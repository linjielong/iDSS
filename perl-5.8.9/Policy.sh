...
case "$prefix" in
'') prefix='/fight4honor/github.com/linjielong/iDSS/localperl' ;;
esac
...
case "$siteprefix" in
'') if test "/fight4honor/github.com/linjielong/iDSS/localperl" = "/fight4honor/github.com/linjielong/iDSS/localperl"; then
	siteprefix="$prefix"
    else
	siteprefix='/fight4honor/github.com/linjielong/iDSS/localperl'
    fi
    ;;
esac
case "$vendorprefix" in
'') if test "" = "/fight4honor/github.com/linjielong/iDSS/localperl"; then
	vendorprefix="$prefix"
    else
	vendorprefix=''
    fi
...
'') if test "/fight4honor/github.com/linjielong/iDSS/localperl" = "/fight4honor/github.com/linjielong/iDSS/localperl"; then
	...
	installprefix='/fight4honor/github.com/linjielong/iDSS/localperl'
    fi
    ;;
esac
...
#     /fight4honor/github.com/linjielong/iDSS/localperl, so it isn't included here either.
#
...
# bin='/fight4honor/github.com/linjielong/iDSS/localperl/bin'
# scriptdir='/fight4honor/github.com/linjielong/iDSS/localperl/bin'
# privlib='/fight4honor/github.com/linjielong/iDSS/localperl/lib/5.8.9'
# archlib='/fight4honor/github.com/linjielong/iDSS/localperl/lib/5.8.9/x86_64-linux'
# man1dir='/fight4honor/github.com/linjielong/iDSS/localperl/man/man1'
# man3dir='/fight4honor/github.com/linjielong/iDSS/localperl/man/man3'
# Preserving custom html1dir
html1dir=' '
# Preserving custom html3dir
html3dir=' '
# sitebin='/fight4honor/github.com/linjielong/iDSS/localperl/bin'
# sitescript='/fight4honor/github.com/linjielong/iDSS/localperl/bin'
# sitelib='/fight4honor/github.com/linjielong/iDSS/localperl/lib/site_perl/5.8.9'
# sitearch='/fight4honor/github.com/linjielong/iDSS/localperl/lib/site_perl/5.8.9/x86_64-linux'
# Preserving custom siteman1dir
siteman1dir='/fight4honor/github.com/linjielong/iDSS/localperl/man/man1'
# Preserving custom siteman3dir
siteman3dir='/fight4honor/github.com/linjielong/iDSS/localperl/man/man3'
